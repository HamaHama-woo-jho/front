...
import { InfoCircleOutlined, PlayCircleOutlined, PlayCircleTwoTone } from '@ant-design/icons';
        ...
        <Card className="border-none text-center shadow-md mx-auto my-3 w-72 sm:w-70 md:w-50">
                ...
                <div className="flex flex-col text-sm my-1">
                    {dummy.info.map(item => (
                        <div className="mb-1" key="info">
                            <HashTag className="px-1 text-gray-500">
                                {`#${item}`}
                            </HashTag>
                        </div>
                    ))}
            ...
            <Card.Footer className="flex p-0 h-9 bg-white">
                <div className="w-1/3 inline-block align-middle text-gray-400">
                    <a href="https://github.com/" target="__blank" rel="noreferrer noopener">
                        <InfoCircleOutlined />
                    </a>
                </div>
                <div className="w-1/3" style={{ borderRightWidth: "1px", borderLeftWidth: "1px" }}>
                    <span className="inline-block align-middle text-gray-400 text-sm">
                        4 / 5
                    </span>
                </div>
                <div
                    className="w-1/3 inline-block align-middle"
                    onClick={onClickEnter}
                >
                    {isIn
                        ? <PlayCircleTwoTone twoToneColor="#f88" />
